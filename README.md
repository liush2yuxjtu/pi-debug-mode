...
![Animated pi-debug-mode workflow preview](https://cdn.jsdelivr.net/gh/liush2yuxjtu/pi-debug-mode@v0.1.9/artifacts/demo/pi-debug-mode-preview.gif)
...
![pi-debug-mode 中文动态工作流预览](https://cdn.jsdelivr.net/gh/liush2yuxjtu/pi-debug-mode@v0.1.9/artifacts/demo/pi-debug-mode-preview-zh.gif)

上方 GIF 会直接循环播放，无需点击。它来自真实机器上的真实 Pi TUI 录屏片段。

- [观看 57 秒真实中文 Pi TUI 录屏](https://cdn.jsdelivr.net/gh/liush2yuxjtu/pi-debug-mode@v0.1.9/artifacts/demo/pi-debug-mode-real-tui-zh.mp4)
- [观看 13 秒中文概念演示](https://cdn.jsdelivr.net/gh/liush2yuxjtu/pi-debug-mode@v0.1.9/artifacts/demo/pi-debug-mode-demo-zh.mp4)
- [打开中文交互演示](https://liush2yuxjtu.github.io/pi-debug-mode/demo-zh.html)

For another English route, [watch the original 13-second product demo](https://cdn.jsdelivr.net/gh/liush2yuxjtu/pi-debug-mode@v0.1.9/artifacts/demo/pi-debug-mode-demo.mp4), [watch the fresh Guided replay](https://cdn.jsdelivr.net/gh/liush2yuxjtu/pi-debug-mode@v0.1.9/artifacts/demo/pi-debug-mode-demo-0.1.8.mp4), or open the [English interactive demo](https://liush2yuxjtu.github.io/pi-debug-mode/demo.html).
